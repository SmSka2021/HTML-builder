...
async function correctString(str){
...
async function readerComponentFolder (arrTags){
  let newHTML=strTemplate_HTML.toString();
  for(let i =0; i<arrTags.length; i++){       
    let item = arrTags[i].toString();
    let data1 = `{{${arrTags[i].toString()}}}`;    
